...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  if ((event.body.toLowerCase() == "𝐑𝐀𝐍𝐀") || (event.body.toLowerCase() == "RANA bai") || (event.body.toLowerCase() == "@RANA") || (event.body.toLowerCase() == "রানা ")) {
   ...
   if ((event.body.toLowerCase() == "Tor boss ke") || (event.body.toLowerCase() == "admin ke ")) {
     return api.sendMessage("My Creator: 𝐑𝐀𝐍𝐀 ❤️ হাই আমি মেছেন্জার ROBOT  আামার বস  𝐑𝐀𝐍𝐀 আমাকে বানিয়েছেন আপনাদের কে হাসানোর জন্য আমি চাই আপনারা সব সময় হাসি খুশি থাকেন", threadID);
   };

  if ((event.body.toLowerCase() == "admin") || (event.body.toLowerCase() == "boter admin")) {
     return api.sendMessage("He is 𝐑𝐎𝐍𝐈❤️ তাকে সবাই রনি নামে  চিনে🤙", threadID);
   };
  ...
  if ((event.body.toLowerCase() ==Khatun
       Khatun "@Mst Jannati Khatun") || (event.body.toLowerCase() == "জান্নাতি")) {
     return api.sendMessage("🥰-জান্নাতি-🌺 আমার বস রনির'বউ লাগে লুচ্ছা বেডা'রা দূরে থাক😠🥰⛏️", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "tnx") || (event.body.toLowerCase() == "ধন্যবাদ") || (event.body.toLowerCase() == "thank you") || (event.body.toLowerCase() == "thanks")) {
     return api.sendMessage("️এতো ধন্যবাদ না দিয়ে পারলে আমার বস রানা কে গার্লফ্রেন্ড টা দিয়ে দে..!🌚⛏️🌶️", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "Name") || (event.body.toLowerCase() == "name") || (event.body.toLowerCase() == "Tor nam ki")) {
     return api.sendMessage("️MY NAME IS °_>—͟͟͞͞𝗕𝗢𝗫-1 𝕯𝗮𝗿𝗶𝗻𝗚 𝑳𝑶𝑽𝑬𝑹 𝐁𝐨𝐭", threadID);
   };
