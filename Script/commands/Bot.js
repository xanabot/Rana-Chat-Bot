...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  if ((event.body.toLowerCase() == "@Sadiya Islam") || (event.body.toLowerCase() == "@Sadiya Islam")) {
     return api.sendMessage("🥰-সাদিয়া🌺 আমার বস রানার'বউ লাগে লুচ্ছা বেডা'রা দূরে থাক😠🥰⛏️", threadID);
   };
